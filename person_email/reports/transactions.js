{
  const o = {
    ...
    components: {
      ...
      a6: { component: 'Scorecard', name: 'Transactions', metrics: [{ eql: 'sum(attributed_revenue)', format: 'currency' }, { eql: 'sum(attributed_transactions)' }] },
      a7: { component: 'Scorecard', name: 'Average Gift', metric: { eql: 'sum(attributed_revenue)/sum(attributed_transactions)', format: 'currency' } },
